...
for x in range(32):
    ...
    bus_controller_to_remote_terminals[x] = DHKE(bus_controller_public_key, remote_terminals_public[x], bus_controller_private_key)

print(bus_controller_to_remote_terminals)